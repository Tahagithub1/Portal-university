...
Route::middleware('auth')->group(function () {
    ...
    // اینجا گروه educational_supervisor بسته می‌شود

    Route::middleware('faculty_head')->group(function () {

        //    Route::resource('/professors', Professor::class)->except('show');
        Route::resource('/time-periods', TimePeriod::class)->only('index');
    ...
    }); // اینجا گروه faculty_head بسته می‌شود
    ...
    Route::middleware('professor')->group(function () {
        ...
        Route::resource('/classrooms', ClassRoom::class)->only('index');

        Route::get('/dashboard', [Dashboard::class, 'index'])->name('dashboard');
        Route::resource('/lessons', Lesson::class)->only('index');
        Route::resource('/professors', Professor::class)->only('index');
        Route::resource('/entries', Entry::class)->only('index');
