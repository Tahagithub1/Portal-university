<nav class="navbar navbar-expand-md bg-primary shadow fixed-top">
    <div class="container">
        ...
        <button class="navbar-toggler ms-2 ms-sm-0" type="button" data-bs-toggle="collapse"
            ...
            <ul class="navbar-nav my-2 my-md-0 me-auto p-0 text-center">
                ...
                @else
                                @php
                                    ...
                                    $terms = App\Models\Term::where('college_id', $currentCollegeID)->paginate(10);

                                    $colleges = App\Models\College::orderBy('name')->get();
                                    $current_college = session('current_college', 'انتخاب نشده');

                                @endphp

                                <li class="d-none d-md-block nav-item dropdown">
                                    <a id="navbarDropdown2" class="nav-link text-white dropdown-toggle" href="#" role="button"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-start text-center" aria-labelledby="navbarDropdown3">
                                            @foreach ($colleges as $college)
                                                <a href="{{ route('colleges.set-college', ['college' => $college->id]) }}"
                                                    class="dropdown-item">{{ $college->name }}</a>
                                            @endforeach
                                            <div>
                                                <hr class="dropdown-divider">
                                            </div>
                                            ...
                                            <a class="dropdown-item" href="{{ route('colleges.create') }}">
                                                <i class="bi bi-plus-lg"></i>
                                                جدید
                                            </a>
                                        </div>
                                ...
                                <li class="d-md-none mb-1">
                                    <button
                                        ...
                                        data-bs-toggle="collapse" data-bs-target="#term-collapse" aria-expanded="false">
                                        ترم :
                                        {{ $current_term ?? 'انتخاب نشده' }}
                                    </button>
                                    <div class="collapse" id="term-collapse" style="">
                                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                            @foreach ($terms as $term)
                                                <li><a href="{{ route('terms.set-term', ['term' => $term->id]) }}"
...
@endif
                                ...
                                <li class="d-md-none mb-1">
                                    <button
                                        class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed text-white"
                                        data-bs-toggle="collapse" data-bs-target="#p-a-collapse" aria-expanded="false">
                                        <i class="bi bi-card-checklist ms-1"></i>
                                        حضور غیاب
                                    </button>
                                    <div class="collapse" id="p-a-collapse">
                                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                            <li><a href="{{ route('p-a.index') }}"
                                                    class="link-body-emphasis d-inline-flex text-decoration-none rounded text-white my-2"><i
                                                        class="bi bi-chevron-left"></i>جدول هفتگی</a></li>
                                            <li><a href="{{ route('p-a.history') }}"
                                                    class="link-body-emphasis d-inline-flex text-decoration-none rounded text-white my-2"><i
                                                        class="bi bi-chevron-left"></i>گزارش گیری چه</a></li>
                                        </ul>
                                    </div>
                                </li>
